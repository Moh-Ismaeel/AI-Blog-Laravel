    ...
    <div class="hero-content">
        ...
        <div class="form flex justify-center items-center">
            ...
            <form action="{{ route('register') }}" method="POST" enctype="multipart/form-data"
                ...
                {{-- button --}}
                <button type="submit"
                    class="bg-neutral-100 text-slate-900 font-semibold text-xl px-4 py-1 rounded-md w-44 mx-auto border border-transparent hover:bg-sky-600 hover:border-solid hover:border-neutral-100 hover:border hover:text-white">Register</button>
